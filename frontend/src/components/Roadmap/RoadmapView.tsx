...
const ECOSYSTEMS = [
  {
    ...
    tooling: 'EVM Language, Rust, Software SDKs, Testing Frameworks, Foundry, and MOR Developer Toolkits',
  ...
  {
    id: 'ethereum',
    name: 'Distributed State Engines',
    ...
    architecture: 'EVM Execution Environment, Gasper Proof-of-Stake Consensus, Execution & Consensus Client Specs',
    tooling: 'EVM Language (^0.8.20), Hardhat, Foundry, Client SDKs, and OpenZeppelin Architecture Libraries',
  ...
  },
  {
    ...
    desc: 'Dedicated Fault-Proof Developer Onboarding Path: Modular Infrastructure, Bedrock Execution Layer, Superchain Inter-Process Messaging, and Public Goods Funding.',
    architecture: 'Fault-Proof Rollup Spec, Bedrock Sequencer Architecture, Cross-Domain Messenger (L1 <-> L2)',
    tooling: 'EVM Language, Devnet CLI, Foundry, Client SDKs, and Ecosystem SDKs',
  ...
  },
  {
    ...
    tooling: 'EVM Language, Polygon CDK CLI, Kurtosis CDK Package, Hardhat, and Foundry',
  ...
  {
    id: 'base',
    name: 'Core Database Frameworks',
    badge: 'High-Performance L2 & Modern App Standard',
    desc: 'Dedicated Core Database Developer Onboarding Path: High-Performance Database Node, Developer Key SDK, React Components, and Gasless Paymasters.',
    architecture: 'Core Database Layer-2 Execution Layer, Account Abstraction & Session Logic',
    tooling: 'EVM Language (^0.8.20), Component Libraries, Starter Kits, Foundry, and MOR Finance APIs',
  ...
  },
  {
    ...
    tooling: 'EVM Language, Avalanche CLI, Teleporter SDK, Hardhat, and Client SDKs',
