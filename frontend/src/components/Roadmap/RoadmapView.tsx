// ─── RoadmapView — core curriculum overview with interactive track switcher ───
...
const CHAIN_LOGOS: Record<string, React.ReactNode> = {
  ...
  ethereum: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <path d="M11.999 1.5L4.5 12.375L11.999 16.5L19.5 12.375L11.999 1.5Z" fill="#627EEA"/>
      <path d="M11.999 16.5L4.5 12.375L11.999 22.5L19.5 12.375L11.999 16.5Z" fill="#8C9EEA"/>
    </svg>
  ),
  arbitrum: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="12" r="10" fill="#28A0F0"/>
      <path d="M7 15L12 7L17 15H14L12 11.5L10 15H7Z" fill="#FFFFFF"/>
    </svg>
  ),
  optimism: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="12" r="10" fill="#FF0420"/>
      <path d="M7 9C7 7.89543 7.89543 7 9 7H15C16.1046 7 17 7.89543 17 9V15C17 16.1046 16.1046 17 15 17H9C7.89543 17 7 16.1046 7 15V9Z" stroke="#FFFFFF" strokeWidth="2"/>
    </svg>
  ),
  polygon: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
...
export const RoadmapView: React.FC<RoadmapViewProps> = ({
  ...
  return (
    <div className="roadmap animate-fade-up">
      {/* Track Switcher Bar */}
      <div className="track-switcher glass">
        <div className="track-switcher__header">
          <div>
            <span className="track-switcher__tag">DEDICATED MULTICHAIN TRACKS</span>
            <h3 className="track-switcher__title">Select Your Blockchain Ecosystem Track</h3>
            <p className="track-switcher__subtitle">
              Switching your track reconfigures your curriculum, smart contract compiler sandboxes, starter repos, and grant-standard certifications:
            </p>
          </div>
        </div>
